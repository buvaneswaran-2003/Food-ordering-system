...
const EditProduct = () => {
  ...
  const fetchCategories = async () =>{
    await axios.get('http://localhost:3001/fetch-categories').then(
      (response)=>{
  ...
  const fetchRestaurant = async () =>{
    await axios.get(`http://localhost:3001/fetch-restaurant-details/${userId}`).then(
      (response)=>{
  ...
  const fetchItem = async () =>{
    await axios.get(`http://localhost:3001/fetch-item-details/${id}`).then(
      (response)=>{
  ...
  const handleUpdateItem = async() =>{
    await axios.put(`http://localhost:3001/update-product/${id}`, {restaurantId: restaurant._id, productName, productDescription, productMainImg, productCategory, productMenuCategory, productNewCategory, productPrice, productDiscount}).then(
      (response)=>{
