...
const Admin = () => {
  ...
  const fetchUsers = async() =>{
    await axios.get('http://localhost:3001/fetch-users').then(
      (response)=>{
  ...
  const fetchOrders = async() =>{
    await axios.get('http://localhost:3001/fetch-orders').then(
      (response)=>{
  ...
  const approveUser = async(id) =>{
    await axios.post('http://localhost:3001/approve-user', {id}).then(
      (response)=>{
  ...
  const rejectUser = async(id) =>{
    await axios.post('http://localhost:3001/reject-user', {id}).then(
      (response)=>{
  ...
  const handlePromoteUpdate = async() =>{
    await axios.post('http://localhost:3001/update-promote-list', {promoteList}).then(
      (response) =>{
  ...
  const fetchPromotions = async () =>{
    await axios.get('http://localhost:3001/fetch-promoted-list').then(
      (response)=>{
